...
class Cactus(Sprite):
    def __init__(self, initial_speed=5, sizex=-1, sizey=-1):
        ...
        self.speed = initial_speed  # Thêm thuộc tính speed và khởi tạo giá trị ban đầu
...
class ChromeDino(object):
    ...
    def step(self, action, record=False):  # 0: Do nothing. 1: Jump. 2: Duck
        ...
        # if self.playerDino.score > 10:
        #     self.gamespeed += 0.005  # Điều chỉnh tăng tốc độ theo mong muốn
